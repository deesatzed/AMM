...
def knowledge_source_manager(amm_design):
    ...
    **Knowledge Source Types:**
    ...
    - **File**: Text files containing reference material, documentation, or specialized knowledge
    ...
    See the Knowledge & Memory Guide for detailed recommendations on when to use each type.
    """)
